...
export const WorkCenterResourceSchema = SchemaFactory.createForClass(WorkCenterResource)
WorkCenterResourceSchema.plugin(mongoosePaginate)

WorkCenterResourceSchema.index({ workcenter: 1, resource: 1 }, { unique: true })