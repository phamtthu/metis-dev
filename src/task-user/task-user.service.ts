...
// import { AddTaskStatusDTO } from "./dto/add-rcategory.dto"
// import { UpdateTaskStatusDTO } from "./dto/update-rcategory.dto"

// @Injectable()
// export class TaskStatusService {

//     constructor(
//         @InjectModel('TaskStatus') private taskStatusModel: PaginateModel<TaskStatus>,
...
//             } else
//                 return await this.taskStatusModel.find(query)
//                     .sort({ 'created_at': SortQuery.Desc })
//         } catch (error) { throwSrvErr(error) }
//     }
