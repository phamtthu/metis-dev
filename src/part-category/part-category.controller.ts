...
export class PartCategoryController {
    ...
    async create(
        ...
        try {
            ...
            const result = await this.partCategoryService.create(pCategoryDTO, originURL)
    ...
    async getList(
        ...
        try {
            const result = await this.partCategoryService.getList({ offset, limit }, search?.trim())
    ...
    async getProductPartFromGivenPartCategory(
        ...
        try {
            const result = await this.partCategoryService.getProductPartFromGivenPartCategory(categoryId)
            return res.status(HttpStatus.OK).json({
                data: result
            })
        } catch (error) { throwCntrllrErr(error) }
